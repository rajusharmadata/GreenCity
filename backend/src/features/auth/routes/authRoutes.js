...
import { validateForgotPassword,validateLogin,validateRegister,validateResetPassword} from '../validators/authValidator.js';

const router = express.Router();

// Public routes
router.post('/register', validateRegister, registerUser);
router.post('/login', validateLogin, loginUser);           // Mobile uses /login
router.post('/login-user', validateLogin, loginUser);      // Web uses /login-user (keep for compatibility)
